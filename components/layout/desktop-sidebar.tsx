...
export const DesktopSidebar = ({
  ...
  return (
    <aside
      className={cn(
        "hidden shrink-0 border-r bg-sidebar/70 py-5 transition-[width,padding] duration-200 md:flex md:flex-col md:justify-between",
        collapsed ? "w-20 px-2" : "w-72 px-4",
      )}
    >
      <div className="space-y-6">
        <div className={cn("flex items-center", collapsed ? "justify-center" : "justify-between")}>
          <Link href="/" className={cn("font-semibold tracking-tight text-foreground", collapsed ? "text-base" : "text-xl")}>
